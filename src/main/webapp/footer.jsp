...
<footer class="flex-rw">
    ...
    <ul class="footer-list-top">
        ...
        <li><a href='/shop/about-mission' class="generic-anchor footer-list-anchor" itemprop="significantLink">GET TO
            KNOW US</a></li>
        ...
        <li><a href='/shop/about-show-schedule' class="generic-anchor footer-list-anchor" itemprop="significantLink">EVENTS</a>
        </li>
    </ul>
    <ul class="footer-list-top">
        <li>
    ...
    <section class="footer-bottom-section flex-rw">
        <div class="footer-bottom-wrapper">
            ...
            <address class="footer-address" role="company address">Bergen, NY</address>
